...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->confirm("If you found an error later that means your package config('laravel-authorization.moduled_permissions') contains a guard not founded in you config('auth.guards') .. ok ?",true);
        $this->publishConfig();
    }
