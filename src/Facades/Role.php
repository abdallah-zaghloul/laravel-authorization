 ...
 * @method static string|null getGuardPrimaryKeyColumn(string $table)
 * @method static string|null getGuardTable(string $guard)
 ...
 * @method static bool assign(string $guardTable,string $guardPrimaryKeyColumn,string $guardPrimaryKey,string $roleId)
